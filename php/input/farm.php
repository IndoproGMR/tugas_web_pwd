...
<body>
    ...
    <form action="" method="post">
        ...
        <input type="text" name="nf" placeholder="Gold Farm MK1000" maxlength="64" require>
        <br>
        Diskripsi:
        ...
        <div>
            ...
            <br>
            <span>&nbsp; X: </span> <input type="number" name="X" placeholder="titik tengah farm" maxlength="11" required>
            <span>&nbsp; Z: </span> <input type="number" name="Z" placeholder="titik tengah farm" maxlength="11" required>
        </div>
